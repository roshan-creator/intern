...
$u=$_POST['Username'];	
$sql="SELECT username FROM Info WHERE username='$u'";
$sql1="SELECT pass FROM Info WHERE username='$u'";
$user=mysqli_query($db,$sql);
$pass=mysqli_query($db,$sql1);
if(isset($_POST['Add']))
{
    if(isset($_POST['Username']) && isset($_POST['Pass']) ) 
    {
        if($_POST['Pass']==$pass && $_POST['Username']==$user)
        {
				...
				<div class="col">
					<div class="home_search_container">
						...
						<div class="home_search_content">
							<form action="Register.php" enctype="multipart/form-data" class="home_search_form" id="home_search_form">
