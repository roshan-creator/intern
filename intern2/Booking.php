...
<div class="super_container">
				...
				<div class="col">
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						<div class="header_content_inner d-flex flex-row align-items-end justify-content-start">
							<div class="logo"><a href="index.php">Travel</a></div>
							<nav class="main_nav">
	...
	<div class="menu">
		<div class="menu_header d-flex flex-row align-items-center justify-content-start">
			<div class="menu_logo"><a href="index.html">Travel</a></div>
			...
			<div class="row">
				<div class="col">
					<div class="home_search_container">
						<div class="home_search_title">Book Your Ticket</div>
						<div class="home_search_content">
							<form action="#" class="home_search_form" id="home_search_form">
								<div class="row justify-content-around">
									<input type="text" class="col-3 search_input search_input_1" placeholder="Name" name="Name" required="required">
                                    <input type="text" class="col-3 search_input search_input_2" placeholder="Gender" name="Gender" required="required">
									<input type="text" class="col-3 search_input search_input_3" placeholder="Guide Name" name="Guide_Name" required="required">
								</div>
                                <br>
                                <div class="row justify-content-around">
									<input type="date" class="col-5 search_input search_input_1" placeholder="From" name="From" required="required">
									<input type="date" class="col-5 search_input search_input_2" placeholder="To" name="To" required="required">
								</div>
                                <br>
                                <div class="row justify-content-around">
									<input type="text" class="col-5 search_input search_input_1" placeholder="Email ID" name="Email_ID" required="required">
									<input type="number" class="col-5 search_input search_input_2" placeholder="Mobile Number" name="Mobile_No." required="required">
								</div>
                                <br>
                                <div class="row justify-content-around">
									<input type="text" class="col-11 search_input search_input_1" placeholder="Venue/Place To Visit" name="Venue" required="required">
								</div>
                                <br>
                                <div class="row justify-content-around">
									<input type="text" class="col-5 search_input search_input_1" placeholder="Book" name="Book" required="required">
									<input type="text" class="col-5 search_input search_input_2" placeholder="Guide Form" name="Guide_Form" required="required">
								</div>
