...
$sql="SELECT username FROM Info WHERE username='".$rows['Username']."'";
$sql1="SELECT pass FROM Info WHERE username='".$rows['Username']."'";
...
if($pass = mysqli_query($db, $sql1)){ 
    if(mysqli_num_rows($pass) > 0){ 
        while($row1 = mysqli_fetch_array($pass)){ 
            $pass1=$row1['pass'];  
		} 
...
if(isset($_POST['Add']))
{
    ...
    {
        if($_POST['Pass']==$pass1[$j] && $_POST['Username']==$user1[$j])
        {
			echo '<script>alert("Login Successful")</script>';
			header('location: Booking.php');
        }
        else{
           	echo '<script>alert("Invalid Credentials! Please Register Yourself")</script>';
    	...
    	echo '<script>alert("All Values are Required")</script>';
    }
...
<div class="super_container">
	...
	<div class="menu">
		<div class="menu_header d-flex flex-row align-items-center justify-content-start">
			<div class="menu_logo"><a href="index.php">Travel</a></div>
			...
			<div class="row">
				<div class="col">
					<div class="home_search_container">
						<div class="home_search_title">Login Here</div>
						<div class="home_search_content">
							<form method="POST" enctype="multipart/form-data" class="home_search_form" id="home_search_form">
								<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
									<input type="text" class="search_input search_input_1" placeholder="Username" name="Username" required="required">
									<input type="password" class="search_input search_input_1" placeholder="Password" name="Pass" required="required">
									<button class="home_search_button" name="Add">Submit</button>
								</div>
							</form>
						</div>
					</div>
