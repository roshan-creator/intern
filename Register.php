...
ini_set("sendmail_from","roshanpatidar161@gmail.com>");
ini_set("smtp_port","587");
$to = $_POST['email_ID'];
$subject = "Login UserID and password";
$msg = "Username=$user and Password=$pass";
$sender = "From: roshanpatidar161@gmail.com"; 

if( mail($to,$subject,$msg,$sender) ) {
	echo '<script>alert("Message sent successfully...Check Your Mail")</script>';
 }else {
				...
				<div class="col">
					<div class="home_search_container">
						...
						<div class="home_search_content">
							<form method="POST" enctype="multipart/form-data" autocomplete="off" class="home_search_form" id="home_search_form">
									...
									<input type="password" class="search_input search_input_3" placeholder="Confirm Password" name="confirm_Pass" required="required">
									<select class="form-select" aria-label="Default select example" name="guide_Name" placeholder="Guide Name">
        								<option value="" disabled selected>Guide Name</option>
